...
namespace Event.Infrastructure.Migrations
{
    ...
    [Migration("20220829113520_group-tables-added")]
    partial class grouptablesadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("groupcategoryseq")
                .IncrementsBy(10);

            modelBuilder.HasSequence("groupmemberseq")
                .IncrementsBy(10);

            modelBuilder.HasSequence("groupseq")
                .IncrementsBy(10);
            ...
            modelBuilder.Entity("Event.Domain.Models.GroupAggregate.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Event.Domain.Models.GroupAggregate.GroupCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Event.Domain.Models.GroupAggregate.GroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Event.Domain.Models.GroupAggregate.MembershipStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("Event.Domain.Models.Master.Category.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Event.Domain.Models.Master.Location.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Event.Domain.Models.EventAggregate.Event", b =>
                {
                    b.HasOne("Event.Domain.Models.GroupAggregate.Group", "Group")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Event.Domain.Models.GroupAggregate.GroupCategory", b =>
                {
                    b.HasOne("Event.Domain.Models.GroupAggregate.Group", null)
                        .WithMany("Categories")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Event.Domain.Models.GroupAggregate.GroupMember", b =>
                {
                    ...
                    b.HasOne("Event.Domain.Models.GroupAggregate.MembershipStatus", "MembershipStatus")
                        .WithMany()
